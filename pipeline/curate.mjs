...
Score 1 always: shopping deals, discount codes, product roundups, buying guides, sponsored content, gadget reviews, event promos and conference tickets, politics, sports, crime, celebrity, generic "how to" listicles, WEEKLY OR MONTHLY FUNDING ROUNDUPS ("startups raised $X this week"), routine "Company X raises $Y Series B" items with no story behind them, quarterly results, partnership announcements, hiring announcements, analyst reports, market-size predictions.
The reader is scrolling Instagram for fun. Every post must be interesting on its own, whatever the category. For funding news, judge the COMPANY, never the amount: what does it actually build, and would a normal person say "wait, that exists?" A $3M round for a startup growing meat from air, a robot that folds laundry, an AI that argues in court, or a brain implant scores HIGH. A $200M round for a generic B2B SaaS or fintech scores LOW. The story is the product and the people, the money is a detail. Same test for AI news: prefer AI doing something surprising or scary, a launch anyone can picture, a founder decision with drama, a failure or lawsuit, a number that makes you say "wait, what?". Low scores (2-4): incremental version updates with no clear result, small funding rounds under $5M with no story, insider jargon, opinion pieces without new facts, duplicate angles on one event (keep the best, score the rest low).
